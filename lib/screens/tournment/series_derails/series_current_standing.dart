...
class SeriesCurrentStandingTab extends StatelessWidget {
  const SeriesCurrentStandingTab({Key? key}) : super(key: key);
      ...
      body: Container(
        ...
        child: ListView.builder(
          ...
          itemBuilder: (context, index) {
            return SeriesCurrentStandingsTabWidget(
...
class SeriesCurrentStandingsTabWidget extends StatefulWidget {
  final CurrentStandlingModel? lastWeek;

  const SeriesCurrentStandingsTabWidget({Key? key, this.lastWeek})
      : super(key: key);

  @override
  State<SeriesCurrentStandingsTabWidget> createState() =>
      _SeriesCurrentStandingsTabWidgetState();
}

class _SeriesCurrentStandingsTabWidgetState
    extends State<SeriesCurrentStandingsTabWidget> {
  bool select = false;
