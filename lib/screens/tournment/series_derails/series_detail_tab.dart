...
class SeriesDetialTabScreen extends StatefulWidget {
  const SeriesDetialTabScreen({Key? key}) : super(key: key);

  @override
  State<SeriesDetialTabScreen> createState() => _SeriesDetialTabScreenState();
}

class _SeriesDetialTabScreenState extends State<SeriesDetialTabScreen> {
  @override
