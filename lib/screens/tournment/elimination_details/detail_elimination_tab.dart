...
class DetailEliminationTabScreen extends StatefulWidget {
  const DetailEliminationTabScreen({Key? key}) : super(key: key);

  @override
  State<DetailEliminationTabScreen> createState() =>
      _DetailEliminationTabScreenState();
}

class _DetailEliminationTabScreenState
    extends State<DetailEliminationTabScreen> {
  @override
