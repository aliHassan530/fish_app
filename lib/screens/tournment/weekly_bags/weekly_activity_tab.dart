...
class WeeklyActivityTab extends StatefulWidget {
  const WeeklyActivityTab({Key? key}) : super(key: key);

  @override
  State<WeeklyActivityTab> createState() => _WeeklyActivityTabState();
}

class _WeeklyActivityTabState extends State<WeeklyActivityTab> {
  @override
