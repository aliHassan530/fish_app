...
class WeeklyBagsDetailTab extends StatefulWidget {
  const WeeklyBagsDetailTab({Key? key}) : super(key: key);

  @override
  State<WeeklyBagsDetailTab> createState() => _WeeklyBagsDetailTabState();
}

class _WeeklyBagsDetailTabState extends State<WeeklyBagsDetailTab> {
  @override
