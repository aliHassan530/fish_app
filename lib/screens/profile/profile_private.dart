...
class ProfilePrivateScreen extends StatefulWidget {
  ...
  @override
  State<ProfilePrivateScreen> createState() => _ProfilePrivateScreenState();
}

class _ProfilePrivateScreenState extends State<ProfilePrivateScreen> {
  bool fellow = false;
  void initState() {
    super.initState();
    checkInit();
