...
import 'package:app/screens/tournment/weekly_bags/weekly_bags.dart';
...
class WeeklyBagsWidget extends StatelessWidget {
  final HomeWidgetModel? home;

  const WeeklyBagsWidget({Key? key, this.home}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    return GestureDetector(
      onTap: (){
        Helper.toScreen(context, WeeklyBagsScreen());
      },
      child: Container(
