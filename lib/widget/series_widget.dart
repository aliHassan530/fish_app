...
import '../screens/tournment/series_derails/series_detail.dart';
import '../utilites/helper.dart';

class SeriesWidget extends StatelessWidget {
  final HomeWidgetModel? home;

  const SeriesWidget({Key? key, this.home}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      onTap: (){
        ...
        Helper.toScreen(context, SeriesDetailScreen());
      },
      child: Container(
